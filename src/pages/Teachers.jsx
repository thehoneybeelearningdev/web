    ...
    <div className="our-teachers">
      <div className="container">
        ...
        <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-4">
          ...
          <div className="col p-3"><div className="item text-center"><div className="image position-relative"><img src={p3} className="img-fluid w-100 rounded-circle" alt="img" /></div><div className="fw-bold my-3 h4">Ms.Karthika</div><div className="fst-italic text-muted">Math Teacher</div></div></div>
          ...
          <div className="col p-3"><div className="item text-center"><div className="image position-relative"><img src={p4} className="img-fluid w-100 rounded-circle" alt="img" /></div><div className="fw-bold my-3 h4">Ms.Swathiga</div><div className="fst-italic text-muted">English Teacher</div></div></div>
